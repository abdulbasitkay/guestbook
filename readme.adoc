...
image:https://github.com/abdulbasitkay/guestbook.svg?branch=master["Build Status", link="https://github.com/abdulbasitkay/guestbook.git"]
...
[source, shell]
----
$ git clone https://github.com/abdulbasitkay/guestbook
$ cd guestbook
$ mvn clean package
$ mvn spring-boot:run
----
